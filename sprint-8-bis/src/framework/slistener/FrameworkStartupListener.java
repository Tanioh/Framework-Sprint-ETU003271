...
import framework.annotation.GetUrl;
import framework.annotation.PostUrl;
import framework.annotation.Url;
import framework.qutils.Rooter;
import framework.servlet.RooterServlet;

@WebListener
public class FrameworkStartupListener implements ServletContextListener {

    @Override
    public void contextInitialized(ServletContextEvent sce) {
        System.out.println(">>>>>>> Application servlet demarree sous Framework <<<<<");
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        System.out.println(">>>>> Application du Framework arretee  <<<<<<");
    }
