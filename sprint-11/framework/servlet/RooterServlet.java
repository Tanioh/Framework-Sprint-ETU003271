...
import framework.annotation.API;
import framework.annotation.FormatApi;
import framework.annotation.RequestParam;
import framework.session.Session;
import framework.tools.ModelView;
import framework.tools.Rooter;
import framework.utils.ReturnAPI;
import framework.utils.TypeCaster;
            ...
            if (m.getName().equals(methodName)) {
                ...
                if (parameters.length == 0) {
                    ...
                    for (int i = 0; i < parameters.length; i++) {
                        ...
                        if (type.getName().equals("framework.session.Session")) {
                ...
                if (m.isAnnotationPresent(API.class)) {
                    ...
                    if (result.getClass().getName().compareToIgnoreCase("java.lang.String") == 0) {
                        out.println(result);
                    } else if (result.getClass().getName().compareToIgnoreCase("framework.tools.ModelView") == 0) {
